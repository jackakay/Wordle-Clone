...
namespace Wordle_Clone_GUI
{
    public partial class Form1 : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            #region more bad code
            if (textBox1.Text.Length != 0)
            {
                labelList[0 + (guessesTaken * 5)].Text = textBox1.Text[0].ToString().ToUpper(); ;
                if (textBox1.Text.Length != 1)
                {
                    labelList[1 + (guessesTaken * 5)].Text = textBox1.Text[1].ToString().ToUpper(); ;
                    if (textBox1.Text.Length != 2)
                    {
                        labelList[2 + (guessesTaken * 5)].Text = textBox1.Text[2].ToString().ToUpper(); ;
                        if (textBox1.Text.Length != 3)
                        {
                            labelList[3 + (guessesTaken * 5)].Text = textBox1.Text[3].ToString().ToUpper(); ;
                            if (textBox1.Text.Length != 4)
                            {
                                labelList[4 + (guessesTaken * 5)].Text = textBox1.Text[4].ToString().ToUpper(); ;

                            }
                            else
                            {
                                labelList[4 + (guessesTaken * 5)].Text = "";
                            }

                        }
                        else
                        {
                            labelList[3 + (guessesTaken * 5)].Text = "";
                        }
                    }
                    else
                    {
                        labelList[2 + (guessesTaken * 5)].Text = "";
                    }
                }
                else
                {
                    labelList[1 + (guessesTaken * 5)].Text = "";
                }
            ...
            {
                labelList[0 + (guessesTaken * 5)].Text = "";
            }
            #endregion
        }
